...
public class LonLatToUTMCoordinateConversion
{
  ...
  public LonLatToUTMCoordinateConversion()
  {
  ...
  public static void main(String[] args)
  {
      try {
	    ...
	    LonLatToUTMCoordinateConversion conv = new LonLatToUTMCoordinateConversion();
		...
		while((line = reader.readLine()) != null)
		{
			...
			if(lineX > AreaToDraw.getSmallestXOfEntireMap() && lineX < AreaToDraw.getLargestXOfEntireMap() && 
				...
				list.add(lineX + " " + lineY); //arr[lineNumber++] = lineX + " " + lineY;
		}
		
		for(String string : list)
			System.out.println(string);
		
		FileOutputStream m_fos = new FileOutputStream(file + "_converted.txt");
