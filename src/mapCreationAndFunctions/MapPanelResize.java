 ...
 * 
 */
public class MapPanelResize extends ComponentAdapter {
	private Timer recalculateTimer = new Timer(250, new MapActionListener());
	 ...
	 */
	public MapPanelResize(MapWindow mw) {
